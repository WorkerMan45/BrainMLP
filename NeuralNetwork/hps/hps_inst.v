	hps u0 (
		...
		.n_layers_external_connection_export     (<connected-to-n_layers_external_connection_export>),     //     n_layers_external_connection.export
		.in_storage_external_connection_export   (<connected-to-in_storage_external_connection_export>),   //   in_storage_external_connection.export
		.sel_storage_external_connection_export  (<connected-to-sel_storage_external_connection_export>),  //  sel_storage_external_connection.export
		.addr_storage_external_connection_export (<connected-to-addr_storage_external_connection_export>), // addr_storage_external_connection.export
		.wr_storage_external_connection_export   (<connected-to-wr_storage_external_connection_export>),   //   wr_storage_external_connection.export
		.in_cons_external_connection_export      (<connected-to-in_cons_external_connection_export>),      //      in_cons_external_connection.export
		.wr_cons_external_connection_export      (<connected-to-wr_cons_external_connection_export>),      //      wr_cons_external_connection.export
		.addr_cons_external_connection_export    (<connected-to-addr_cons_external_connection_export>),    //    addr_cons_external_connection.export
		.prop_external_connection_export         (<connected-to-prop_external_connection_export>),         //         prop_external_connection.export
		.out_cons_external_connection_export     (<connected-to-out_cons_external_connection_export>),     //     out_cons_external_connection.export
		.out_storage_external_connection_export  (<connected-to-out_storage_external_connection_export>)   //  out_storage_external_connection.export
	);
